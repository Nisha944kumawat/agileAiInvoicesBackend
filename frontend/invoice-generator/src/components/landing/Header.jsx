          ...
          <div className="hidden lg:flex items-center space-x-4">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className="bg-gradient-to-r from-blue-400 to-blue-500 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                >
                  Sign Up
                </Link>
              </>
